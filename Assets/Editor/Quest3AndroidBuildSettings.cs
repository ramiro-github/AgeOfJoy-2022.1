...
public class Quest3AndroidBuildSettings : IPreprocessBuildWithReport
{
    ...
    static void ApplyOculusQuestTargets(bool log)
    {
        ...
        EditorUtility.SetDirty(settings as Object);
    ...
    static void ApplyPassthroughManifest(bool log)
    {
        ...
        if (log)
            Debug.Log("[Quest3AndroidBuildSettings] MR passthrough: manifest=Supported, loading=ContextualPassthrough, splash=off");
    }
